...
layout(std140) uniform StandardMaterial_base_color { // set = 3, binding = 0
    vec4 base_color;
};
...
layout(std140) uniform StandardMaterial_roughness { // set = 3, binding = 3
    float perceptual_roughness;
};

layout(std140) uniform StandardMaterial_metallic { // set = 3, binding = 4
    float metallic;
};
